...
const DICT = {
  zh: {
    ...
    settings_agentApi_desc: '启动后可通过本地 HTTP API 管理物品数据。Token 用于鉴权，请勿泄露。',
  ...
  en: {
    ...
    settings_agentApi_desc: 'Manage inventory data via local HTTP API when the app is running. Keep the token secret.',
