...
- **v1.5.0**：侧栏/分类/斑马纹/动画批量优化（UX-13~16）
- **v1.4.x**：UX-11 过期预警列表、UX-12 统计图表动效、UX-17 图片上传进度、UX-18 批量拖拽
- **v1.3.x**：UX-01~10 交互优化批量上线；批量编辑 XSS 防护
- **v1.2.16**：设置页重排：数据管理置顶，更新日志/新功能置底
